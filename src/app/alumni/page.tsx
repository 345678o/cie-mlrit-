...
const alumni: Alumni[] = [
  {
    name: "Deepthi Daggubati",
    batch: "2025–26",
    role: "Software Engineer",
    company: "HrSoft",
    photo: "/alumni/Deepthi.jpeg",
    linkedin: "https://www.linkedin.com/in/deepthi-daggubati/",
    quote: "College life, for me, was CIE. If it weren't for CIE, my college journey would've been completely different. I joined as a Creative Team member and somehow found my way into Promotions. Looking back, I realize this journey gave me so much more than memories, it shaped my character and helped me build skills I'll carry for life, from leadership and communication to teamwork, adaptability, and problem-solving. Every challenge, from hosting and organizing events to working behind the scenes and promoting them in every possible way, pushed me to grow and somehow pull all the strings to make the impossible happen. CIE made me truly understand the hype around taking up challenges boldly. And of course, none of it would've been the same without the amazing people through all the friendships, rivalries, chaos, and memories. In the end, every bit of it was worth it and forever grateful for this opportunity!",
  },
  {
    name: "Mayur Borgaonker",
    batch: "2024–25",
    role: "Indian Navy",
    company: "Indian Navy",
    photo: "/alumni/Mayur.jpeg",
    linkedin: "https://www.linkedin.com/in/mayur-borgaonker-553924202/",
    quote: "Being a part of CIE has been a truly unforgettable experience. It became a place where I learned, grew, and created memories that I'll always cherish. From organizing innovative events to being a part of Spotlight, our student-led podcast initiative, every opportunity pushed me to think differently and grow as a person. One of the experiences I'll always be grateful for is mentoring my juniors in the Promotions & Sponsorship department and helping them build confidence in their communication skills. More than the events and achievements, it's the people, the laughter, the teamwork, and the countless memories that make CIE so special to me. It will always hold a special place in my heart, and I'll look back at this journey with nothing but gratitude and nostalgia.",
  },
  {
    ...
    linkedin: "https://www.linkedin.com/in/avhilash-tripathy/",
  ...
  },
  {
    ...
    role: "AI-QA Engineer",
    company: "ETI",
    photo: "/alumni/Indra Reddy M.png",
    linkedin: "https://in.linkedin.com/in/m-indra-reddy",
    quote: "In my first year, I really wanted to get into CIE, honestly just because it looked cool. I missed that chance somehow. Then near the end of second year, I got a chance to be a Microproject Mentor, and I'm so glad I didn't let that one slip too.That mentoring journey shaped a big part of who I am today. Working with freshers, guiding them, watching them build their ideas, being part of the Innovation Challenge together, all of it. It changed how I think about leadership, learning, and solving problems. And by the end, I realized CIE was never just a place that looked cool. It's the people and the work that make it special, and I am glad I got to be part of it.",
    tags: ["Tech", "Leadership"],
  },
];
