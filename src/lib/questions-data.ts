...
export const QUESTIONS_DATA: Record<DeptKey, Question[]> = {
  ...
  photography: [
    ...
    { id: "photography_q5", label: "Briefly explain why you chose this photograph.", type: "textarea", options: [], required: true, order: 5 },
    { id: "photography_q6", label: "If you increase the ISO to a very high value, how will it affect the image?", type: "textarea", options: [], required: true, order: 6 },
    { id: "photography_q7", label: "If your image has too much noise (grain), what could be the reason?", type: "textarea", options: [], required: true, order: 7 },
    { id: "photography_q8", label: "How do you make a video more engaging for the audience?", type: "textarea", options: [], required: true, order: 8 },
    { id: "photography_q9", label: "What do you think is more important in videography: Camera quality or Creativity? Why?", type: "textarea", options: [], required: true, order: 9 },
    ...
    { id: "photography_q12", label: "How do you usually organize your editing workflow?", type: "textarea", options: [], required: true, order: 12 },
    ...
    { id: "photography_q14", label: "Describe one editing project you have worked on and explain your contribution.", type: "textarea", options: [], required: true, order: 14 },
