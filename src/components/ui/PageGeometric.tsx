  ...
  return (
    <div aria-hidden style={{ position: "absolute", inset: 0, pointerEvents: "none", overflow: "hidden", zIndex: 0 }}>
      ...
      <svg style={{ position: "absolute", top: "-16%", right: "-8%", width: "48vw", height: "48vw", maxWidth: 560, maxHeight: 560 }}
        ...
        <circle cx="280" cy="280" r="260" stroke="#FF5E2C" strokeWidth="70" fill="none" opacity="0.07" />
      </svg>
      ...
      <svg style={{ position: "absolute", bottom: "-12%", right: "-5%", width: "26vw", height: "26vw", maxWidth: 300, maxHeight: 300 }}
        ...
        <circle cx="150" cy="150" r="130" stroke="#FF5E2C" strokeWidth="44" fill="none" opacity="0.055" />
      </svg>
      ...
      <svg style={{ position: "absolute", bottom: 0, left: 0, width: "32vw", height: "32vw", maxWidth: 380, maxHeight: 380 }}
        ...
        <path d="M0,380 L260,380 L0,120 Z" fill="#FF5E2C" opacity="0.055" />
        <path d="M0,380 L160,380 L0,240 Z" fill="#FF5E2C" opacity="0.035" />
      </svg>

      {/* Small arc — top left */}
      <svg style={{ position: "absolute", top: "-6%", left: "-6%", width: "18vw", height: "18vw", maxWidth: 200, maxHeight: 200 }}
        viewBox="0 0 200 200" fill="none">
        <circle cx="100" cy="100" r="86" stroke="#FF5E2C" strokeWidth="34" fill="none" opacity="0.06" />
      </svg>
      ...
      <div style={{
        ...
        backgroundImage: "radial-gradient(circle, rgba(255,94,44,0.28) 1.5px, transparent 1.5px)",
      ...
      <div style={{
        ...
        backgroundImage: "radial-gradient(circle, rgba(255,94,44,0.18) 1.5px, transparent 1.5px)",
      ...
      <svg style={{ position: "absolute", inset: 0, width: "100%", height: "100%" }}
        ...
        <line x1="0" y1="900" x2="1440" y2="0" stroke="#FF5E2C" strokeWidth="1" opacity="0.06" />
      </svg>
